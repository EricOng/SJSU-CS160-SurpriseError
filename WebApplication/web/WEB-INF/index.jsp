		...
		<div class="mainbar">
			...
			<div  style="float:none;width:650px;margin-left:auto;margin-right:auto;margin-top:18px;">	
                            <form class="searchform" method="POST" action="SearchServlet">
                                ...
                                <input class="searchfield" name="keyword" style="width: 200px;"type="text" placeholder="Keywords: Javascript, Afterschool..." onfocus="if (this.value == 'Keywords: Javascript, Afterschool...') {this.value = '';}" onblur="if (this.value == '') {this.value = '';}">
                                <input class="searchfield" name="zipcode" style="width: 100px;" type="text" placeholder="Near: zipcode" onfocus="if (this.value == 'Search...') {this.value = '';}" onblur="if (this.value == 'zipcode') {this.value = '';}">
