...
import Handlers.BusinessUserRegisterHandler;
 ...
 * @author David Ho
 */
@WebServlet(name = "BusinessUserRegisterServlet", urlPatterns = {"/BusinessUserRegisterServlet"})
public class BusinessUserRegisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getQueryString() != null) {
            ...
            BusinessUserRegisterHandler handler = new BusinessUserRegisterHandler();
