...
import Handlers.CasualUserRegisterHandler;
 ...
 * @author David
 */
@WebServlet(name = "CasualUserRegisterServlets", urlPatterns = {"/CasualUserRegisterServlets"})
public class CasualUserRegisterServlets extends HttpServlet {
